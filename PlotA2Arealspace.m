...
%--Transparent Lines---%
for i=1:numel(a1)
%     l = patchline([xposa1(i),xposa2(i)],[yposa1(i),yposa2(i)],'linestyle','-','edgecolor',colors(i,:),'linewidth',5,'edgealpha',0.5);
      l = line([xposa1(i),xposa2(i)],[yposa1(i),yposa2(i)],'linestyle','-','Color',colors(i,:),'linewidth',2);
end
set(gca,'FontSize',18);
%--Solid Lines---%
% x=[xposa1;xposa2];
